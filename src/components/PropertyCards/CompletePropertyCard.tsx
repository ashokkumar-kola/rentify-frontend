...
const PropertyOverviewCard: React.FC<PropertyCardProps> = ({ property }) => {
	...
	const displayAmenities =
		amenities.length > 0 ? amenities : defaultAmenities;
		...
		<View style={[styles.card, { width: cardWidth }]}>
			...
			>
				<View
					style={[
						styles.tag,
						{ backgroundColor: isForRent ? "#34d399" : "#3b82f6" },
					]}
				>
					<FontAwesome
			...
			<View style={styles.priceBadge}>
				...
				{isForRent && (
					<Text style={styles.depositText}>
						<FontAwesome name="lock" size={10} /> Deposit:{" "}
						{priceType}
						{deposit}
					</Text>
				)}
			...
			<View style={styles.content}>
				...
				<View style={styles.tagsRow}>
					{displayAmenities.map((tag, index) => (
						<View
							key={index}
							style={[
								styles.labelTag,
...
//           <FontAwesome name={isForRent ? 'exchange' : 'tags'} size={12} color="#fff" style={styles.tagIcon} />
...
//               <FontAwesome name={tag.icon} size={10} color="#fff" style={styles.tagIcon} />
//               <Text style={styles.labelTagText}>{tag.label}</Text>
//             </View>
//           ))}
//         </View>
