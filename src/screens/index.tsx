...
export { default as ExplorePropertiesScreen } from './properties/ExplorePropertiesScreen';
...
export { default as PropertyDetailsScreen } from './properties/PropertyDetailsScreen';
export { default as PropertyMapScreen } from './properties/PropertyMapScreen';
