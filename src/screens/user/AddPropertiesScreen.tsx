...
const AddPropertyScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    const title = `${propertyType} ${bhkType ? `${bhkType} BHK` : ''} in ${locality}`;
    ...
    if (bathrooms) {propertyData.bathrooms = parseInt(bathrooms, 10);}
    if (deposit) {propertyData.deposit = parseFloat(deposit);}
    if (floor) {propertyData.floor_no = parseInt(floor, 10);}
    if (totalFloors) {propertyData.total_floors = parseInt(totalFloors, 10);}
    if (area) {propertyData.area = parseFloat(area);}
    if (carpetArea) {propertyData.carpet_area = parseFloat(carpetArea);}
    if (facing) {propertyData.facing = facing;}
    if (builtYear) {propertyData.built_year = parseInt(builtYear, 10);}
    if (furnishing) {propertyData.furnishing = furnishing;}
    if (amenities && amenities.length > 0) {propertyData.amenities = amenities;}
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionHeader}>
        <MaterialIcons name="maps-home-work" size={16} color="#4F46E5" style={styles.icon} />
      ...
      <View style={styles.row}>
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="king-bed" size={16} color="#4F46E5" style={styles.icon} />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="bathtub" size={16} color="#4F46E5" style={styles.icon} />
      ...
      <View style={styles.row}>
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="currency-rupee" size={20} color="#4F46E5" style={styles.icon} />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="check-circle-outline" size={20} color="#4F46E5" style={styles.icon} />
      ...
      {/* Location */}
        <View style={styles.row}>
          <View style={styles.inputContainer}>
            <View style={styles.sectionHeader}>
              <MaterialIcons name="my-location" size={20} color="#4F46E5" style={styles.icon} />
              <AppText style={styles.label}>Locality <AppText style={styles.required}>*</AppText></AppText>
            </View>
            <TextInput
              style={styles.input}
              value={locality}
          ...
          <View style={styles.inputContainer}>
            <View style={styles.sectionHeader}>
              <MaterialIcons name="location-city" size={20} color="#4F46E5" style={styles.icon} />
      ...
      <View style={styles.row}>
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="stairs" size={16} color="#4F46E5" style={styles.icon} />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="layers" size={16} color="#4F46E5" style={styles.icon} />
      ...
      <View style={styles.row}>
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="square-foot" size={16} color="#4F46E5" style={styles.icon} />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="crop-square" size={16} color="#4F46E5" style={styles.icon} />
      ...
      <View style={styles.row}>
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="explore" size={16} color="#4F46E5" style={styles.icon} />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.sectionHeader}>
            <MaterialIcons name="calendar-today" size={16} color="#4F46E5" style={styles.icon} />
      ...
      {/* Furnishing */}
      <View style={styles.sectionHeader}>
        <MaterialIcons name="weekend" size={16} color="#4F46E5" style={styles.icon} />
      ...
      {/* Amenities */}
      <View style={styles.sectionHeader}>
        <MaterialIcons name="checklist" size={16} color="#4F46E5" style={styles.icon} />
      ...
      {/* Description */}
      <View style={styles.sectionHeader}>
        <MaterialIcons name="description" size={16} color="#4F46E5" style={styles.icon} />
      ...
      <View style={styles.fixedButtonContainer}>
        <TouchableOpacity style={styles.submitButton} onPress={handleSubmit} activeOpacity={0.8}>
          <MaterialIcons name="add-home-work" size={24} color="#FFFFFF" style={styles.submitIcon} />
